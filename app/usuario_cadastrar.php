...
<script type="text/javascript">
	...
	function envia_dados_form(){
		...
		$.ajax({
                url: '../api/?controle=usuario&acao=cadastrar', 
                type: 'POST',
				data: formData,
				contentType: false, 
				processData: false, 
                ...
                error: function(xhr, status, error) {
                    ...
                    alert('Houve um problema ao cadastrar o usuario.');
                }
        });
	...
	function valida_form_du_ca(){
		...
		if($('input[name="foto_us"]').val() == ""){ 
			mensagem = mensagem + "- O campo foto é obrigatório. \n"; 
			erro = true; 
		}
...
<fieldset>
	...
	<form id="form_du" action="" enctype="multipart/form-data" method="post" name="form_du">
		...
		<table cellpadding="5" cellspacing="0">
			...
			<tr>	
				<td colspan="2"> 
					<input type="button" value="Cadastrar" onclick="valida_form_du_ca();" /> 
